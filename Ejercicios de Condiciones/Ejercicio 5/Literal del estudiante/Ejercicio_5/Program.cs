...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            Console.WriteLine("La calificacion ingresada fue: " + calificación);

            Console.WriteLine("La situacion del estudiante esta excelente");
        }
        ...
        else if (calificación >= 80)
        {
            ...
            Console.WriteLine("La situacion del estudiante esta muy bien");
        }
        ...
        else 
        {
            ...
            Console.WriteLine("La situacion del estudiante esta deficiente");
        }
